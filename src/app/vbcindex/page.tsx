    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 animate-in fade-in slide-in-from-left-8 duration-1000 ease-out-expo">
              ...
              <Link href={content.ctaTopUrl} target={content.ctaTopUrl.startsWith('http') ? "_blank" : undefined} rel={content.ctaTopUrl.startsWith('http') ? "noopener noreferrer" : undefined} className="brand-button-primary group">
                {content.ctaTop}
      ...
      <section className="py-24 bg-brand-dark text-white overflow-hidden relative border-t border-brand-plum/10">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <Link href={content.ctaBottomUrl} target={content.ctaBottomUrl.startsWith('http') ? "_blank" : undefined} rel={content.ctaBottomUrl.startsWith('http') ? "noopener noreferrer" : undefined} className="brand-button-inverted px-12 py-5 text-lg group">
            {content.ctaBottom}
            <ArrowRight className="ml-3 w-5 h-5 transition-transform group-hover:translate-x-1" />
          </Link>
        </div>
