    ...
    <div className="bg-white">
      ...
      <section className="pt-24 pb-20 border-b border-brand-neutral relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          ...
          <p className="text-xl md:text-2xl text-brand-plum/80 max-w-3xl leading-relaxed italic border-l-2 border-brand-gold pl-12">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col gap-32 lg:gap-40">
            {workPage.entries.map((entry, index) => (
              <article key={entry.id} id={entry.slug} className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 relative">
                <div className="lg:col-span-5 lg:sticky lg:top-40 lg:self-start">
                  <div className="flex items-center gap-6 mb-8">
                    ...
                    <div className="h-px flex-1 bg-brand-plum/20" />
                  </div>
                  <h2 className="text-4xl md:text-5xl lg:text-6xl mb-6 group-hover:text-brand-plum transition-colors leading-tight text-brand-dark font-display font-bold">
                    {entry.company}
                  </h2>
                ...
                <div className="lg:col-span-7 flex flex-col gap-16">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                    <div className="space-y-6">
                      <h3 className="text-[12px] font-bold uppercase tracking-[0.4em] text-brand-plum/70 border-b border-brand-neutral pb-4">
                  ...
                  <div className="bg-brand-dark p-10 lg:p-12 relative overflow-hidden group shadow-bold rounded-xl border border-white/5">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-[12px] font-bold uppercase tracking-[0.4em] text-brand-gold/80 mb-8 flex items-center gap-3">
