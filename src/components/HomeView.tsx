...
export default function HomeView({ data, blogPosts }: HomeViewProps) {
  ...
  return (
    <div className="flex flex-col text-brand-dark overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 bg-white border-b border-brand-plum/10">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out-expo">
            <div className="inline-flex items-center gap-3 mb-12">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.4em] text-brand-plum/80">{homepage.hero.badge}</span>
            </div>
            
            <h1 className="text-6xl lg:text-[6.5rem] mb-12 tracking-tight leading-[1.05]">
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-12 mt-16">
              ...
              <p className="text-xl text-brand-plum/70 max-w-md leading-relaxed italic border-l-2 border-brand-gold pl-10 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            {homepage.valueProps.map((prop, i) => (
              <div key={i} className="group p-2">
                <div className="w-12 h-px bg-brand-gold/60 mb-10 group-hover:w-20 transition-all duration-700" />
                <h3 className="text-2xl font-bold mb-6 text-white leading-tight">
                  {prop.title}
                </h3>
                <p className="text-brand-neutral/60 leading-relaxed text-lg italic">
                  {prop.description}
                </p>
              </div>
            ))}
      ...
      {/* How It Works */}
      <section className="py-32 lg:py-48 bg-brand-neutral/30 border-y border-brand-plum/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-32">
            <div className="max-w-2xl text-brand-dark">
              <h2 className="text-5xl lg:text-6xl mb-8 font-display">
                {homepage.howItWorksHeadline}
              </h2>
              <p className="text-brand-plum/70 text-xl italic border-l-2 border-brand-gold pl-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {homepage.howItWorks.map((step, i) => (
              <div key={i} className="brand-card group">
                <span className="text-[10px] font-bold text-brand-plum/60 uppercase tracking-[0.4em] mb-12 block">
                  Step 0{i + 1}
                </span>
                <h3 className="text-2xl mb-6 text-brand-plum font-bold">{step.title}</h3>
                <p className="text-brand-plum/80 leading-relaxed italic text-lg">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 lg:py-48 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="bg-brand-neutral/30 p-12 lg:p-24 relative overflow-hidden group border border-brand-neutral rounded-xl shadow-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
              <div className="lg:col-span-7 relative z-10">
                <div className="inline-flex items-center gap-4 mb-10">
                  <span className="px-3 py-1 bg-brand-dark text-white text-[10px] font-bold uppercase tracking-[0.3em] rounded-sm">New Product</span>
                  <div className="h-px w-12 bg-brand-dark/20" />
                </div>
                <h2 className="text-5xl lg:text-6xl mb-10 font-display text-brand-dark leading-tight">
                  {homepage.vbcIndexSection.headline}
                </h2>
                <p className="text-2xl text-brand-plum/70 mb-16 leading-relaxed italic border-l-2 border-brand-plum pl-10">
      ...
      {mainFeaturedPost && (
        <section className="py-40 lg:py-64 bg-brand-plum text-white relative overflow-hidden px-6">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10">
            ...
            <h2 className="text-4xl lg:text-[6rem] mb-16 italic tracking-tight leading-[1.1] font-display text-white">
      ...
      <section className="py-32 lg:py-48 bg-white px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-32 pb-12 border-b border-brand-neutral">
            <div>
              <h2 className="text-5xl lg:text-6xl mb-6 font-bold text-brand-plum tracking-tight font-display">
                {homepage.workPreviewHeadline}
              </h2>
              <p className="text-brand-plum/70 italic text-2xl border-l-2 border-brand-gold pl-8">Selected initiatives</p>
            </div>
            <Link href="/work" className="text-[11px] font-bold uppercase tracking-[0.3em] text-brand-plum hover:text-brand-dark transition-colors border-b-2 border-brand-gold pb-2">
              ...
              <div key={work.id} className="group grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative">
                ...
                <div className="lg:col-span-5 lg:sticky lg:top-40 lg:self-start">
                  <div className="flex items-center gap-4 mb-8">
                    <span className="text-[10px] font-bold text-brand-plum/80 uppercase tracking-[0.5em]">
                      {work.company}
                    </span>
                    <div className="h-px flex-1 bg-brand-neutral" />
                  </div>
                  <h3 className="text-4xl lg:text-5xl mb-8 group-hover:text-brand-plum transition-colors leading-tight text-brand-dark font-display">
                    {work.title}
                  </h3>
                  <Link href={`/work#${work.slug}`} className="inline-flex items-center text-[10px] font-bold uppercase tracking-[0.4em] group/link text-brand-plum/80 hover:text-brand-plum transition-colors border-b border-transparent hover:border-brand-gold/50 pb-1">
                ...
                <div className="lg:col-span-7 pt-12 lg:pt-20 border-t lg:border-t-0 lg:border-l border-brand-neutral lg:pl-20">
                  <p className="text-brand-dark text-2xl lg:text-3xl leading-relaxed italic border-l-4 border-brand-gold pl-10">
                    {work.description}
                  </p>
                </div>
              </div>
      ...
      {/* Insights Preview */}
      <section className="py-32 lg:py-48 bg-brand-neutral/30 border-t border-brand-plum/5 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-32">
            <div className="max-w-2xl text-brand-dark">
              <h2 className="text-5xl lg:text-6xl mb-8 leading-tight font-bold tracking-tight font-display">
                {homepage.insightsPreview.headline}
              </h2>
              <p className="text-brand-plum/70 text-xl leading-relaxed italic border-l-2 border-brand-gold pl-10">
              ...
              <article key={post.id} className="brand-card group">
                <div className="flex flex-col h-full">
                  <div className="flex items-center gap-4 mb-10">
                    <div className="px-3 py-1 bg-brand-gold/20 text-brand-plum text-[10px] font-bold uppercase tracking-[0.2em] rounded-full">
                      Article
                    </div>
                    <div className="h-px flex-1 bg-brand-plum/10" />
                  </div>
                  <h3 className="text-3xl mb-8 italic leading-snug group-hover:text-brand-plum transition-colors font-display text-brand-dark font-bold">
                    {post.title}
                  </h3>
                  <p className="text-brand-plum/70 text-lg mb-12 line-clamp-3 leading-relaxed italic">{post.description}</p>
                  <div className="mt-auto pt-10 border-t border-brand-plum/10">
                    <Link href={`/insights/${post.slug}`} className="text-[11px] font-bold uppercase tracking-[0.4em] inline-flex items-center group/link text-brand-plum/70 hover:text-brand-plum transition-all duration-500">
                      {homepage.featuredInsightSection.readArticleCta}
